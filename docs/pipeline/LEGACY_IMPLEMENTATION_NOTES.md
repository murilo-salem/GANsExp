...
> Este documento preserva comandos anteriores à reorganização direta. Para comandos atuais,
> use [a referência da pipeline](README.md) e as receitas em `configs/stages/`.
